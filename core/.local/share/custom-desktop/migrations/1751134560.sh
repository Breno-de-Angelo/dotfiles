...
export OMARCHY_PATH="$HOME/.local/share/custom-desktop"
...
mkdir -p ~/.local/state/custom-desktop/migrations
touch ~/.local/state/custom-desktop/migrations/1751134560.sh
...
touch ~/.local/state/custom-desktop/migrations/1756060611.sh
